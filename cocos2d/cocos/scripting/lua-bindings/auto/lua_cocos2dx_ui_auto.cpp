...
int lua_cocos2dx_ui_Text_parseRichText(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::Text* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_Text_parseRichText'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "ccui.Text:parseRichText"); arg0 = arg0_tmp.c_str();
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_Text_parseRichText'", nullptr);
            return 0;
        }
        cobj->parseRichText(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.Text:parseRichText",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_Text_parseRichText'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_Text(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Text");
        ...
        tolua_function(tolua_S,"parseRichText",lua_cocos2dx_ui_Text_parseRichText);
...
int lua_cocos2dx_ui_ScrollView_autoScrollHorizontal(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::ScrollView* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_ScrollView_autoScrollHorizontal'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 3) 
    {
        ...
        ok &= luaval_to_number(tolua_S, 2,&arg0, "ccui.ScrollView:autoScrollHorizontal");

        ok &= luaval_to_number(tolua_S, 3,&arg1, "ccui.ScrollView:autoScrollHorizontal");

        ok &= luaval_to_boolean(tolua_S, 4,&arg2, "ccui.ScrollView:autoScrollHorizontal");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_ScrollView_autoScrollHorizontal'", nullptr);
            return 0;
        }
        cobj->autoScrollHorizontal(arg0, arg1, arg2);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.ScrollView:autoScrollHorizontal",argc, 3);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_ScrollView_autoScrollHorizontal'.",&tolua_err);
#endif
...
int lua_cocos2dx_ui_ScrollView_enableFixedDistanceScroll(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::ScrollView* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_ScrollView_enableFixedDistanceScroll'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_number(tolua_S, 2,&arg0, "ccui.ScrollView:enableFixedDistanceScroll");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_ScrollView_enableFixedDistanceScroll'", nullptr);
            return 0;
        }
        cobj->enableFixedDistanceScroll(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.ScrollView:enableFixedDistanceScroll",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_ScrollView_enableFixedDistanceScroll'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_ScrollView(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"ScrollView");
        ...
        tolua_function(tolua_S,"autoScrollHorizontal",lua_cocos2dx_ui_ScrollView_autoScrollHorizontal);
        ...
        tolua_function(tolua_S,"enableFixedDistanceScroll",lua_cocos2dx_ui_ScrollView_enableFixedDistanceScroll);
...
int lua_cocos2dx_ui_EditBox_showKeyboard(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::EditBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_EditBox_showKeyboard'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_EditBox_showKeyboard'", nullptr);
            return 0;
        }
        cobj->showKeyboard();
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.EditBox:showKeyboard",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_EditBox_showKeyboard'.",&tolua_err);
#endif
...
int lua_cocos2dx_ui_EditBox_hidDefaultKeyboard(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::EditBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_EditBox_hidDefaultKeyboard'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_EditBox_hidDefaultKeyboard'", nullptr);
            return 0;
        }
        cobj->hidDefaultKeyboard();
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.EditBox:hidDefaultKeyboard",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_EditBox_hidDefaultKeyboard'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_EditBox(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"EditBox");
        ...
        tolua_function(tolua_S,"showKeyboard",lua_cocos2dx_ui_EditBox_showKeyboard);
        ...
        tolua_function(tolua_S,"hidDefaultKeyboard",lua_cocos2dx_ui_EditBox_hidDefaultKeyboard);
...
int lua_cocos2dx_ui_RichItem_init(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItem* cobj = nullptr;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"ccui.RichItem",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (cocos2d::ui::RichItem*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichItem_init'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 3) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ccui.RichItem:init");

        ok &= luaval_to_color3b(tolua_S, 3, &arg1, "ccui.RichItem:init");

        ok &= luaval_to_uint16(tolua_S, 4,&arg2, "ccui.RichItem:init");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItem_init'", nullptr);
            return 0;
        }
        bool ret = cobj->init(arg0, arg1, arg2);
        tolua_pushboolean(tolua_S,(bool)ret);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItem:init",argc, 3);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItem_init'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichItem_getContext(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItem* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichItem_getContext'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItem_getContext'", nullptr);
            return 0;
        }
        std::string ret = cobj->getContext();
        tolua_pushcppstring(tolua_S,ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItem:getContext",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItem_getContext'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichItem_setContext(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItem* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichItem_setContext'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "ccui.RichItem:setContext");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItem_setContext'", nullptr);
            return 0;
        }
        cobj->setContext(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItem:setContext",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItem_setContext'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichItem_constructor(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItem* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItem_constructor'", nullptr);
            return 0;
        }
        cobj = new cocos2d::ui::RichItem();
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,"ccui.RichItem");
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItem:RichItem",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItem_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_cocos2dx_ui_RichItem_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (RichItem)");
    return 0;
}

int lua_register_cocos2dx_ui_RichItem(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"ccui.RichItem");
    tolua_cclass(tolua_S,"RichItem","ccui.RichItem","cc.Ref",nullptr);

    tolua_beginmodule(tolua_S,"RichItem");
        tolua_function(tolua_S,"new",lua_cocos2dx_ui_RichItem_constructor);
        tolua_function(tolua_S,"init",lua_cocos2dx_ui_RichItem_init);
        tolua_function(tolua_S,"getContext",lua_cocos2dx_ui_RichItem_getContext);
        tolua_function(tolua_S,"setContext",lua_cocos2dx_ui_RichItem_setContext);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocos2d::ui::RichItem).name();
    g_luaType[typeName] = "ccui.RichItem";
    g_typeCast["RichItem"] = "ccui.RichItem";
    return 1;
}

int lua_cocos2dx_ui_RichItemNewLine_init(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemNewLine* cobj = nullptr;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"ccui.RichItemNewLine",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (cocos2d::ui::RichItemNewLine*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichItemNewLine_init'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ccui.RichItemNewLine:init");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemNewLine_init'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemNewLine:init",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemNewLine_init'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichItemNewLine_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S,1,"ccui.RichItemNewLine",0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    {
        int arg0;
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ccui.RichItemNewLine:create");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemNewLine_create'", nullptr);
            return 0;
        }
        cocos2d::ui::RichItemNewLine* ret = cocos2d::ui::RichItemNewLine::create(arg0);
        object_to_luaval<cocos2d::ui::RichItemNewLine>(tolua_S, "ccui.RichItemNewLine",(cocos2d::ui::RichItemNewLine*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "ccui.RichItemNewLine:create",argc, 1);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemNewLine_create'.",&tolua_err);
#endif
    return 0;
}
int lua_cocos2dx_ui_RichItemNewLine_constructor(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemNewLine* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemNewLine_constructor'", nullptr);
            return 0;
        }
        cobj = new cocos2d::ui::RichItemNewLine();
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,"ccui.RichItemNewLine");
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemNewLine:RichItemNewLine",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemNewLine_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_cocos2dx_ui_RichItemNewLine_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (RichItemNewLine)");
    return 0;
}

int lua_register_cocos2dx_ui_RichItemNewLine(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"ccui.RichItemNewLine");
    tolua_cclass(tolua_S,"RichItemNewLine","ccui.RichItemNewLine","ccui.RichItem",nullptr);

    tolua_beginmodule(tolua_S,"RichItemNewLine");
        tolua_function(tolua_S,"new",lua_cocos2dx_ui_RichItemNewLine_constructor);
        tolua_function(tolua_S,"init",lua_cocos2dx_ui_RichItemNewLine_init);
        tolua_function(tolua_S,"create", lua_cocos2dx_ui_RichItemNewLine_create);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocos2d::ui::RichItemNewLine).name();
    g_luaType[typeName] = "ccui.RichItemNewLine";
    g_typeCast["RichItemNewLine"] = "ccui.RichItemNewLine";
    return 1;
}

int lua_cocos2dx_ui_RichItemText_init(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemText* cobj = nullptr;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"ccui.RichItemText",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (cocos2d::ui::RichItemText*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichItemText_init'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 6) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ccui.RichItemText:init");

        ok &= luaval_to_color3b(tolua_S, 3, &arg1, "ccui.RichItemText:init");

        ok &= luaval_to_uint16(tolua_S, 4,&arg2, "ccui.RichItemText:init");

        std::string arg3_tmp; ok &= luaval_to_std_string(tolua_S, 5, &arg3_tmp, "ccui.RichItemText:init"); arg3 = arg3_tmp.c_str();

        std::string arg4_tmp; ok &= luaval_to_std_string(tolua_S, 6, &arg4_tmp, "ccui.RichItemText:init"); arg4 = arg4_tmp.c_str();

        ok &= luaval_to_number(tolua_S, 7,&arg5, "ccui.RichItemText:init");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemText_init'", nullptr);
            return 0;
        }
        bool ret = cobj->init(arg0, arg1, arg2, arg3, arg4, arg5);
        tolua_pushboolean(tolua_S,(bool)ret);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemText:init",argc, 6);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemText_init'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichItemText_enableOutLine(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemText* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichItemText_enableOutLine'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        ok &=luaval_to_color4b(tolua_S, 2, &arg0, "ccui.RichItemText:enableOutLine");

        ok &= luaval_to_uint16(tolua_S, 3,&arg1, "ccui.RichItemText:enableOutLine");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemText_enableOutLine'", nullptr);
            return 0;
        }
        cobj->enableOutLine(arg0, arg1);
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemText:enableOutLine",argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemText_enableOutLine'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichItemText_enableLinkLine(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemText* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichItemText_enableLinkLine'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        ok &=luaval_to_color4b(tolua_S, 2, &arg0, "ccui.RichItemText:enableLinkLine");

        ok &= luaval_to_uint16(tolua_S, 3,&arg1, "ccui.RichItemText:enableLinkLine");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemText_enableLinkLine'", nullptr);
            return 0;
        }
        cobj->enableLinkLine(arg0, arg1);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemText:enableLinkLine",argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemText_enableLinkLine'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichItemText_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S,1,"ccui.RichItemText",0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    if (argc == 6)
    {
        ...
        const char* arg4;
        double arg5;
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ccui.RichItemText:create");
        ok &= luaval_to_color3b(tolua_S, 3, &arg1, "ccui.RichItemText:create");
        ok &= luaval_to_uint16(tolua_S, 4,&arg2, "ccui.RichItemText:create");
        std::string arg3_tmp; ok &= luaval_to_std_string(tolua_S, 5, &arg3_tmp, "ccui.RichItemText:create"); arg3 = arg3_tmp.c_str();
        std::string arg4_tmp; ok &= luaval_to_std_string(tolua_S, 6, &arg4_tmp, "ccui.RichItemText:create"); arg4 = arg4_tmp.c_str();
        ok &= luaval_to_number(tolua_S, 7,&arg5, "ccui.RichItemText:create");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemText_create'", nullptr);
            return 0;
        }
        cocos2d::ui::RichItemText* ret = cocos2d::ui::RichItemText::create(arg0, arg1, arg2, arg3, arg4, arg5);
        object_to_luaval<cocos2d::ui::RichItemText>(tolua_S, "ccui.RichItemText",(cocos2d::ui::RichItemText*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "ccui.RichItemText:create",argc, 6);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemText_create'.",&tolua_err);
#endif
    return 0;
}
int lua_cocos2dx_ui_RichItemText_constructor(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemText* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemText_constructor'", nullptr);
            return 0;
        }
        cobj = new cocos2d::ui::RichItemText();
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,"ccui.RichItemText");
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemText:RichItemText",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemText_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_cocos2dx_ui_RichItemText_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (RichItemText)");
    return 0;
}

int lua_register_cocos2dx_ui_RichItemText(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"ccui.RichItemText");
    tolua_cclass(tolua_S,"RichItemText","ccui.RichItemText","ccui.RichItem",nullptr);

    tolua_beginmodule(tolua_S,"RichItemText");
        tolua_function(tolua_S,"new",lua_cocos2dx_ui_RichItemText_constructor);
        tolua_function(tolua_S,"init",lua_cocos2dx_ui_RichItemText_init);
        tolua_function(tolua_S,"enableOutLine",lua_cocos2dx_ui_RichItemText_enableOutLine);
        tolua_function(tolua_S,"enableLinkLine",lua_cocos2dx_ui_RichItemText_enableLinkLine);
        tolua_function(tolua_S,"create", lua_cocos2dx_ui_RichItemText_create);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocos2d::ui::RichItemText).name();
    g_luaType[typeName] = "ccui.RichItemText";
    g_typeCast["RichItemText"] = "ccui.RichItemText";
    return 1;
}

int lua_cocos2dx_ui_RichItemImage_init(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemImage* cobj = nullptr;
    bool ok  = true;
#if COCOS2D_DEBUG >= 1
    tolua_Error tolua_err;
#endif
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"ccui.RichItemImage",0,&tolua_err)) goto tolua_lerror;
#endif
    cobj = (cocos2d::ui::RichItemImage*)tolua_tousertype(tolua_S,1,0);
#if COCOS2D_DEBUG >= 1
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichItemImage_init'", nullptr);
        return 0;
    }
#endif
    argc = lua_gettop(tolua_S)-1;
    do{
        if (argc == 4) {
            int arg0;
            ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ccui.RichItemImage:init");

            if (!ok) { break; }
            cocos2d::Color3B arg1;
            ok &= luaval_to_color3b(tolua_S, 3, &arg1, "ccui.RichItemImage:init");

            if (!ok) { break; }
            uint16_t arg2;
            ok &= luaval_to_uint16(tolua_S, 4,&arg2, "ccui.RichItemImage:init");
    ...
    do{
        if (argc == 4) {
            ...
            if (!ok) { break; }
            const char* arg3;
            std::string arg3_tmp; ok &= luaval_to_std_string(tolua_S, 5, &arg3_tmp, "ccui.RichItemImage:init"); arg3 = arg3_tmp.c_str();
    ...
    do{
        if (argc == 4) {
            ...
            if (!ok) { break; }
            cocos2d::ui::ImageView* arg3;
            ok &= luaval_to_object<cocos2d::ui::ImageView>(tolua_S, 5, "ccui.ImageView",&arg3);
    ...
    ok  = true;
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n",  "ccui.RichItemImage:init",argc, 4);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemImage_init'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichItemImage_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
#if COCOS2D_DEBUG >= 1
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S,1,"ccui.RichItemImage",0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    do 
    {
        ...
        {
            int arg0;
            ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ccui.RichItemImage:create");
            if (!ok) { break; }
            cocos2d::Color3B arg1;
            ok &= luaval_to_color3b(tolua_S, 3, &arg1, "ccui.RichItemImage:create");
            if (!ok) { break; }
            uint16_t arg2;
            ok &= luaval_to_uint16(tolua_S, 4,&arg2, "ccui.RichItemImage:create");
            if (!ok) { break; }
            cocos2d::Sprite* arg3;
            ok &= luaval_to_object<cocos2d::Sprite>(tolua_S, 5, "cc.Sprite",&arg3);
            if (!ok) { break; }
            cocos2d::ui::RichItemImage* ret = cocos2d::ui::RichItemImage::create(arg0, arg1, arg2, arg3);
            object_to_luaval<cocos2d::ui::RichItemImage>(tolua_S, "ccui.RichItemImage",(cocos2d::ui::RichItemImage*)ret);
            return 1;
        }
    } while (0);
    ok  = true;
    do 
    {
        if (argc == 4)
        {
            ...
            if (!ok) { break; }
            const char* arg3;
            std::string arg3_tmp; ok &= luaval_to_std_string(tolua_S, 5, &arg3_tmp, "ccui.RichItemImage:create"); arg3 = arg3_tmp.c_str();
            if (!ok) { break; }
            cocos2d::ui::RichItemImage* ret = cocos2d::ui::RichItemImage::create(arg0, arg1, arg2, arg3);
            object_to_luaval<cocos2d::ui::RichItemImage>(tolua_S, "ccui.RichItemImage",(cocos2d::ui::RichItemImage*)ret);
            return 1;
    ...
    ok  = true;
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d", "ccui.RichItemImage:create",argc, 4);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemImage_create'.",&tolua_err);
#endif
    return 0;
}
int lua_cocos2dx_ui_RichItemImage_constructor(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemImage* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemImage_constructor'", nullptr);
            return 0;
        }
        cobj = new cocos2d::ui::RichItemImage();
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,"ccui.RichItemImage");
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemImage:RichItemImage",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemImage_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_cocos2dx_ui_RichItemImage_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (RichItemImage)");
    return 0;
}

int lua_register_cocos2dx_ui_RichItemImage(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"ccui.RichItemImage");
    tolua_cclass(tolua_S,"RichItemImage","ccui.RichItemImage","ccui.RichItem",nullptr);

    tolua_beginmodule(tolua_S,"RichItemImage");
        tolua_function(tolua_S,"new",lua_cocos2dx_ui_RichItemImage_constructor);
        tolua_function(tolua_S,"init",lua_cocos2dx_ui_RichItemImage_init);
        tolua_function(tolua_S,"create", lua_cocos2dx_ui_RichItemImage_create);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocos2d::ui::RichItemImage).name();
    g_luaType[typeName] = "ccui.RichItemImage";
    g_typeCast["RichItemImage"] = "ccui.RichItemImage";
    return 1;
}

int lua_cocos2dx_ui_RichItemCustom_init(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemCustom* cobj = nullptr;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"ccui.RichItemCustom",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (cocos2d::ui::RichItemCustom*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichItemCustom_init'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 4) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ccui.RichItemCustom:init");

        ok &= luaval_to_color3b(tolua_S, 3, &arg1, "ccui.RichItemCustom:init");

        ok &= luaval_to_uint16(tolua_S, 4,&arg2, "ccui.RichItemCustom:init");

        ok &= luaval_to_object<cocos2d::Node>(tolua_S, 5, "cc.Node",&arg3);
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemCustom_init'", nullptr);
            return 0;
        }
        bool ret = cobj->init(arg0, arg1, arg2, arg3);
        tolua_pushboolean(tolua_S,(bool)ret);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemCustom:init",argc, 4);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemCustom_init'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichItemCustom_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S,1,"ccui.RichItemCustom",0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    if (argc == 4)
    {
        ...
        uint16_t arg2;
        cocos2d::Node* arg3;
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ccui.RichItemCustom:create");
        ok &= luaval_to_color3b(tolua_S, 3, &arg1, "ccui.RichItemCustom:create");
        ok &= luaval_to_uint16(tolua_S, 4,&arg2, "ccui.RichItemCustom:create");
        ok &= luaval_to_object<cocos2d::Node>(tolua_S, 5, "cc.Node",&arg3);
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemCustom_create'", nullptr);
            return 0;
        }
        cocos2d::ui::RichItemCustom* ret = cocos2d::ui::RichItemCustom::create(arg0, arg1, arg2, arg3);
        object_to_luaval<cocos2d::ui::RichItemCustom>(tolua_S, "ccui.RichItemCustom",(cocos2d::ui::RichItemCustom*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "ccui.RichItemCustom:create",argc, 4);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemCustom_create'.",&tolua_err);
#endif
    return 0;
}
int lua_cocos2dx_ui_RichItemCustom_constructor(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemCustom* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemCustom_constructor'", nullptr);
            return 0;
        }
        cobj = new cocos2d::ui::RichItemCustom();
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,"ccui.RichItemCustom");
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemCustom:RichItemCustom",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemCustom_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_cocos2dx_ui_RichItemCustom_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (RichItemCustom)");
    return 0;
}

int lua_register_cocos2dx_ui_RichItemCustom(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"ccui.RichItemCustom");
    tolua_cclass(tolua_S,"RichItemCustom","ccui.RichItemCustom","ccui.RichItem",nullptr);

    tolua_beginmodule(tolua_S,"RichItemCustom");
        tolua_function(tolua_S,"new",lua_cocos2dx_ui_RichItemCustom_constructor);
        tolua_function(tolua_S,"init",lua_cocos2dx_ui_RichItemCustom_init);
        tolua_function(tolua_S,"create", lua_cocos2dx_ui_RichItemCustom_create);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocos2d::ui::RichItemCustom).name();
    g_luaType[typeName] = "ccui.RichItemCustom";
    g_typeCast["RichItemCustom"] = "ccui.RichItemCustom";
    return 1;
}

int lua_cocos2dx_ui_LinkLable_getLinkline(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::LinkLable* cobj = nullptr;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"ccui.LinkLable",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (cocos2d::ui::LinkLable*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_LinkLable_getLinkline'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_LinkLable_getLinkline'", nullptr);
            return 0;
        }
        cocos2d::LayerColor* ret = cobj->getLinkline();
        object_to_luaval<cocos2d::LayerColor>(tolua_S, "cc.LayerColor",(cocos2d::LayerColor*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.LinkLable:getLinkline",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_LinkLable_getLinkline'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_LinkLable_enableLinkLine(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::LinkLable* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_LinkLable_enableLinkLine'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        ok &=luaval_to_color4b(tolua_S, 2, &arg0, "ccui.LinkLable:enableLinkLine");

        ok &= luaval_to_uint16(tolua_S, 3,&arg1, "ccui.LinkLable:enableLinkLine");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_LinkLable_enableLinkLine'", nullptr);
            return 0;
        }
        cobj->enableLinkLine(arg0, arg1);
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.LinkLable:enableLinkLine",argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_LinkLable_enableLinkLine'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_LinkLable_setLableDelegate(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::LinkLable* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_LinkLable_setLableDelegate'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        cocos2d::ui::LableDelegate* arg0;

        ok &= luaval_to_object<cocos2d::ui::LableDelegate>(tolua_S, 2, "ccui.LableDelegate",&arg0);
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_LinkLable_setLableDelegate'", nullptr);
            return 0;
        }
        cobj->setLableDelegate(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.LinkLable:setLableDelegate",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_LinkLable_setLableDelegate'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_LinkLable_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S,1,"ccui.LinkLable",0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    if (argc == 3)
    {
        ...
        std::string arg1;
        double arg2;
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "ccui.LinkLable:create");
        ok &= luaval_to_std_string(tolua_S, 3,&arg1, "ccui.LinkLable:create");
        ok &= luaval_to_number(tolua_S, 4,&arg2, "ccui.LinkLable:create");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_LinkLable_create'", nullptr);
            return 0;
        }
        cocos2d::ui::LinkLable* ret = cocos2d::ui::LinkLable::create(arg0, arg1, arg2);
        object_to_luaval<cocos2d::ui::LinkLable>(tolua_S, "ccui.LinkLable",(cocos2d::ui::LinkLable*)ret);
        return 1;
    }
    if (argc == 4)
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 3,&arg1, "ccui.LinkLable:create");
        ok &= luaval_to_number(tolua_S, 4,&arg2, "ccui.LinkLable:create");
        ok &= luaval_to_size(tolua_S, 5, &arg3, "ccui.LinkLable:create");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_LinkLable_create'", nullptr);
            return 0;
        }
        cocos2d::ui::LinkLable* ret = cocos2d::ui::LinkLable::create(arg0, arg1, arg2, arg3);
        object_to_luaval<cocos2d::ui::LinkLable>(tolua_S, "ccui.LinkLable",(cocos2d::ui::LinkLable*)ret);
        return 1;
    }
    if (argc == 5)
    {
        ...
        ok &= luaval_to_number(tolua_S, 4,&arg2, "ccui.LinkLable:create");
        ok &= luaval_to_size(tolua_S, 5, &arg3, "ccui.LinkLable:create");
        ok &= luaval_to_int32(tolua_S, 6,(int *)&arg4, "ccui.LinkLable:create");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_LinkLable_create'", nullptr);
            return 0;
        }
        cocos2d::ui::LinkLable* ret = cocos2d::ui::LinkLable::create(arg0, arg1, arg2, arg3, arg4);
        object_to_luaval<cocos2d::ui::LinkLable>(tolua_S, "ccui.LinkLable",(cocos2d::ui::LinkLable*)ret);
        return 1;
    }
    if (argc == 6)
    {
        ...
        ok &= luaval_to_size(tolua_S, 5, &arg3, "ccui.LinkLable:create");
        ok &= luaval_to_int32(tolua_S, 6,(int *)&arg4, "ccui.LinkLable:create");
        ok &= luaval_to_int32(tolua_S, 7,(int *)&arg5, "ccui.LinkLable:create");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_LinkLable_create'", nullptr);
            return 0;
        }
        cocos2d::ui::LinkLable* ret = cocos2d::ui::LinkLable::create(arg0, arg1, arg2, arg3, arg4, arg5);
        object_to_luaval<cocos2d::ui::LinkLable>(tolua_S, "ccui.LinkLable",(cocos2d::ui::LinkLable*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "ccui.LinkLable:create",argc, 3);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_LinkLable_create'.",&tolua_err);
#endif
    return 0;
}
int lua_cocos2dx_ui_LinkLable_constructor(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::LinkLable* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_LinkLable_constructor'", nullptr);
            return 0;
        }
        cobj = new cocos2d::ui::LinkLable();
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,"ccui.LinkLable");
        return 1;
    }
    if (argc == 1) 
    {
        cocos2d::FontAtlas* arg0;

        ok &= luaval_to_object<cocos2d::FontAtlas>(tolua_S, 2, "cc.FontAtlas",&arg0);
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_LinkLable_constructor'", nullptr);
            return 0;
        }
        cobj = new cocos2d::ui::LinkLable(arg0);
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,"ccui.LinkLable");
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 3,(int *)&arg1, "ccui.LinkLable:LinkLable");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_LinkLable_constructor'", nullptr);
            return 0;
        }
        cobj = new cocos2d::ui::LinkLable(arg0, arg1);
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,"ccui.LinkLable");
    ...
    if (argc == 3) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 4,(int *)&arg2, "ccui.LinkLable:LinkLable");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_LinkLable_constructor'", nullptr);
            return 0;
        }
        cobj = new cocos2d::ui::LinkLable(arg0, arg1, arg2);
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,"ccui.LinkLable");
    ...
    if (argc == 4) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 5,&arg3, "ccui.LinkLable:LinkLable");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_LinkLable_constructor'", nullptr);
            return 0;
        }
        cobj = new cocos2d::ui::LinkLable(arg0, arg1, arg2, arg3);
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,"ccui.LinkLable");
    ...
    if (argc == 5) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 6,&arg4, "ccui.LinkLable:LinkLable");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_LinkLable_constructor'", nullptr);
            return 0;
        }
        cobj = new cocos2d::ui::LinkLable(arg0, arg1, arg2, arg3, arg4);
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,"ccui.LinkLable");
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.LinkLable:LinkLable",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_LinkLable_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_cocos2dx_ui_LinkLable_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (LinkLable)");
    return 0;
}

int lua_register_cocos2dx_ui_LinkLable(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"ccui.LinkLable");
    tolua_cclass(tolua_S,"LinkLable","ccui.LinkLable","cc.Label",nullptr);

    tolua_beginmodule(tolua_S,"LinkLable");
        tolua_function(tolua_S,"new",lua_cocos2dx_ui_LinkLable_constructor);
        tolua_function(tolua_S,"getLinkline",lua_cocos2dx_ui_LinkLable_getLinkline);
        tolua_function(tolua_S,"enableLinkLine",lua_cocos2dx_ui_LinkLable_enableLinkLine);
        tolua_function(tolua_S,"setLableDelegate",lua_cocos2dx_ui_LinkLable_setLableDelegate);
        tolua_function(tolua_S,"create", lua_cocos2dx_ui_LinkLable_create);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocos2d::ui::LinkLable).name();
    g_luaType[typeName] = "ccui.LinkLable";
    g_typeCast["LinkLable"] = "ccui.LinkLable";
    return 1;
}

int lua_cocos2dx_ui_RichItemFactory_createRichItem(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemFactory* cobj = nullptr;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"ccui.RichItemFactory",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (cocos2d::ui::RichItemFactory*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichItemFactory_createRichItem'", nullptr);
        return 0;
    }
#endif
    ...
    {
        const char* arg0;
        cocos2d::ui::RichItemContext* arg1;

        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "ccui.RichItemFactory:createRichItem"); arg0 = arg0_tmp.c_str();

        #pragma warning NO CONVERSION TO NATIVE FOR RichItemContext*
		ok = false;
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemFactory_createRichItem'", nullptr);
            return 0;
        }
        cocos2d::ui::RichItem* ret = cobj->createRichItem(arg0, arg1);
        object_to_luaval<cocos2d::ui::RichItem>(tolua_S, "ccui.RichItem",(cocos2d::ui::RichItem*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemFactory:createRichItem",argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemFactory_createRichItem'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichItemFactory_constructor(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemFactory* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemFactory_constructor'", nullptr);
            return 0;
        }
        cobj = new cocos2d::ui::RichItemFactory();
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,"ccui.RichItemFactory");
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemFactory:RichItemFactory",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemFactory_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_cocos2dx_ui_RichItemFactory_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (RichItemFactory)");
    return 0;
}

int lua_register_cocos2dx_ui_RichItemFactory(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"ccui.RichItemFactory");
    tolua_cclass(tolua_S,"RichItemFactory","ccui.RichItemFactory","cc.Ref",nullptr);

    tolua_beginmodule(tolua_S,"RichItemFactory");
        tolua_function(tolua_S,"new",lua_cocos2dx_ui_RichItemFactory_constructor);
        tolua_function(tolua_S,"createRichItem",lua_cocos2dx_ui_RichItemFactory_createRichItem);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocos2d::ui::RichItemFactory).name();
    g_luaType[typeName] = "ccui.RichItemFactory";
    g_typeCast["RichItemFactory"] = "ccui.RichItemFactory";
    return 1;
}

int lua_cocos2dx_ui_RichItemTextFactory_init(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemTextFactory* cobj = nullptr;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"ccui.RichItemTextFactory",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (cocos2d::ui::RichItemTextFactory*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichItemTextFactory_init'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemTextFactory_init'", nullptr);
            return 0;
        }
        bool ret = cobj->init();
        tolua_pushboolean(tolua_S,(bool)ret);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemTextFactory:init",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemTextFactory_init'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichItemTextFactory_createRichItem(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemTextFactory* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichItemTextFactory_createRichItem'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "ccui.RichItemTextFactory:createRichItem"); arg0 = arg0_tmp.c_str();

        #pragma warning NO CONVERSION TO NATIVE FOR RichItemContext*
		ok = false;
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemTextFactory_createRichItem'", nullptr);
            return 0;
        }
        cocos2d::ui::RichItem* ret = cobj->createRichItem(arg0, arg1);
        object_to_luaval<cocos2d::ui::RichItem>(tolua_S, "ccui.RichItem",(cocos2d::ui::RichItem*)ret);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemTextFactory:createRichItem",argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemTextFactory_createRichItem'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichItemTextFactory_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S,1,"ccui.RichItemTextFactory",0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemTextFactory_create'", nullptr);
            return 0;
        }
        cocos2d::ui::RichItemTextFactory* ret = cocos2d::ui::RichItemTextFactory::create();
        object_to_luaval<cocos2d::ui::RichItemTextFactory>(tolua_S, "ccui.RichItemTextFactory",(cocos2d::ui::RichItemTextFactory*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "ccui.RichItemTextFactory:create",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemTextFactory_create'.",&tolua_err);
#endif
    return 0;
}
int lua_cocos2dx_ui_RichItemTextFactory_constructor(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemTextFactory* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemTextFactory_constructor'", nullptr);
            return 0;
        }
        cobj = new cocos2d::ui::RichItemTextFactory();
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,"ccui.RichItemTextFactory");
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemTextFactory:RichItemTextFactory",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemTextFactory_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_cocos2dx_ui_RichItemTextFactory_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (RichItemTextFactory)");
    return 0;
}

int lua_register_cocos2dx_ui_RichItemTextFactory(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"ccui.RichItemTextFactory");
    tolua_cclass(tolua_S,"RichItemTextFactory","ccui.RichItemTextFactory","ccui.RichItemFactory",nullptr);

    tolua_beginmodule(tolua_S,"RichItemTextFactory");
        tolua_function(tolua_S,"new",lua_cocos2dx_ui_RichItemTextFactory_constructor);
        tolua_function(tolua_S,"init",lua_cocos2dx_ui_RichItemTextFactory_init);
        tolua_function(tolua_S,"createRichItem",lua_cocos2dx_ui_RichItemTextFactory_createRichItem);
        tolua_function(tolua_S,"create", lua_cocos2dx_ui_RichItemTextFactory_create);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocos2d::ui::RichItemTextFactory).name();
    g_luaType[typeName] = "ccui.RichItemTextFactory";
    g_typeCast["RichItemTextFactory"] = "ccui.RichItemTextFactory";
    return 1;
}

int lua_cocos2dx_ui_RichItemImageFactory_init(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemImageFactory* cobj = nullptr;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"ccui.RichItemImageFactory",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (cocos2d::ui::RichItemImageFactory*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichItemImageFactory_init'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemImageFactory_init'", nullptr);
            return 0;
        }
        bool ret = cobj->init();
        tolua_pushboolean(tolua_S,(bool)ret);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemImageFactory:init",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemImageFactory_init'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichItemImageFactory_createSprite(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemImageFactory* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichItemImageFactory_createSprite'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemImageFactory_createSprite'", nullptr);
            return 0;
        }
        cocos2d::Sprite* ret = cobj->createSprite();
        object_to_luaval<cocos2d::Sprite>(tolua_S, "cc.Sprite",(cocos2d::Sprite*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemImageFactory:createSprite",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemImageFactory_createSprite'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichItemImageFactory_createRichItem(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemImageFactory* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichItemImageFactory_createRichItem'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "ccui.RichItemImageFactory:createRichItem"); arg0 = arg0_tmp.c_str();

        #pragma warning NO CONVERSION TO NATIVE FOR RichItemContext*
		ok = false;
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemImageFactory_createRichItem'", nullptr);
            return 0;
        }
        cocos2d::ui::RichItem* ret = cobj->createRichItem(arg0, arg1);
        object_to_luaval<cocos2d::ui::RichItem>(tolua_S, "ccui.RichItem",(cocos2d::ui::RichItem*)ret);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemImageFactory:createRichItem",argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemImageFactory_createRichItem'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichItemImageFactory_createImageView(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemImageFactory* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichItemImageFactory_createImageView'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemImageFactory_createImageView'", nullptr);
            return 0;
        }
        cocos2d::ui::ImageView* ret = cobj->createImageView();
        object_to_luaval<cocos2d::ui::ImageView>(tolua_S, "ccui.ImageView",(cocos2d::ui::ImageView*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemImageFactory:createImageView",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemImageFactory_createImageView'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichItemImageFactory_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S,1,"ccui.RichItemImageFactory",0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemImageFactory_create'", nullptr);
            return 0;
        }
        cocos2d::ui::RichItemImageFactory* ret = cocos2d::ui::RichItemImageFactory::create();
        object_to_luaval<cocos2d::ui::RichItemImageFactory>(tolua_S, "ccui.RichItemImageFactory",(cocos2d::ui::RichItemImageFactory*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "ccui.RichItemImageFactory:create",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemImageFactory_create'.",&tolua_err);
#endif
    return 0;
}
int lua_cocos2dx_ui_RichItemImageFactory_constructor(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichItemImageFactory* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichItemImageFactory_constructor'", nullptr);
            return 0;
        }
        cobj = new cocos2d::ui::RichItemImageFactory();
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,"ccui.RichItemImageFactory");
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichItemImageFactory:RichItemImageFactory",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichItemImageFactory_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_cocos2dx_ui_RichItemImageFactory_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (RichItemImageFactory)");
    return 0;
}

int lua_register_cocos2dx_ui_RichItemImageFactory(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"ccui.RichItemImageFactory");
    tolua_cclass(tolua_S,"RichItemImageFactory","ccui.RichItemImageFactory","ccui.RichItemFactory",nullptr);

    tolua_beginmodule(tolua_S,"RichItemImageFactory");
        tolua_function(tolua_S,"new",lua_cocos2dx_ui_RichItemImageFactory_constructor);
        tolua_function(tolua_S,"init",lua_cocos2dx_ui_RichItemImageFactory_init);
        tolua_function(tolua_S,"createSprite",lua_cocos2dx_ui_RichItemImageFactory_createSprite);
        tolua_function(tolua_S,"createRichItem",lua_cocos2dx_ui_RichItemImageFactory_createRichItem);
        tolua_function(tolua_S,"createImageView",lua_cocos2dx_ui_RichItemImageFactory_createImageView);
        tolua_function(tolua_S,"create", lua_cocos2dx_ui_RichItemImageFactory_create);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocos2d::ui::RichItemImageFactory).name();
    g_luaType[typeName] = "ccui.RichItemImageFactory";
    g_typeCast["RichItemImageFactory"] = "ccui.RichItemImageFactory";
    return 1;
}

int lua_cocos2dx_ui_RichTextManager_loadStyles(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextManager* cobj = nullptr;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"ccui.RichTextManager",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (cocos2d::ui::RichTextManager*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextManager_loadStyles'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "ccui.RichTextManager:loadStyles"); arg0 = arg0_tmp.c_str();
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextManager_loadStyles'", nullptr);
            return 0;
        }
        cobj->loadStyles(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 3,&arg1, "ccui.RichTextManager:loadStyles");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextManager_loadStyles'", nullptr);
            return 0;
        }
        cobj->loadStyles(arg0, arg1);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextManager:loadStyles",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextManager_loadStyles'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextManager_getFactory(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextManager* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextManager_getFactory'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "ccui.RichTextManager:getFactory");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextManager_getFactory'", nullptr);
            return 0;
        }
        cocos2d::ui::RichItemFactory* ret = cobj->getFactory(arg0);
        object_to_luaval<cocos2d::ui::RichItemFactory>(tolua_S, "ccui.RichItemFactory",(cocos2d::ui::RichItemFactory*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextManager:getFactory",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextManager_getFactory'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextManager_loadStylesByData(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextManager* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextManager_loadStylesByData'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_ccvaluemap(tolua_S, 2, &arg0, "ccui.RichTextManager:loadStylesByData");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextManager_loadStylesByData'", nullptr);
            return 0;
        }
        cobj->loadStylesByData(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextManager:loadStylesByData",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextManager_loadStylesByData'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextManager_DestroyInstance(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S,1,"ccui.RichTextManager",0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextManager_DestroyInstance'", nullptr);
            return 0;
        }
        cocos2d::ui::RichTextManager::DestroyInstance();
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "ccui.RichTextManager:DestroyInstance",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextManager_DestroyInstance'.",&tolua_err);
#endif
    return 0;
}
int lua_cocos2dx_ui_RichTextManager_getInstance(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextManager_getInstance'", nullptr);
            return 0;
        }
        cocos2d::ui::RichTextManager* ret = cocos2d::ui::RichTextManager::getInstance();
        object_to_luaval<cocos2d::ui::RichTextManager>(tolua_S, "ccui.RichTextManager",(cocos2d::ui::RichTextManager*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "ccui.RichTextManager:getInstance",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextManager_getInstance'.",&tolua_err);
#endif
    return 0;
}
int lua_cocos2dx_ui_RichTextManager_constructor(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextManager* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextManager_constructor'", nullptr);
            return 0;
        }
        cobj = new cocos2d::ui::RichTextManager();
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,"ccui.RichTextManager");
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextManager:RichTextManager",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextManager_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_cocos2dx_ui_RichTextManager_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (RichTextManager)");
    return 0;
}

int lua_register_cocos2dx_ui_RichTextManager(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"ccui.RichTextManager");
    tolua_cclass(tolua_S,"RichTextManager","ccui.RichTextManager","cc.Ref",nullptr);

    tolua_beginmodule(tolua_S,"RichTextManager");
        tolua_function(tolua_S,"new",lua_cocos2dx_ui_RichTextManager_constructor);
        tolua_function(tolua_S,"loadStyles",lua_cocos2dx_ui_RichTextManager_loadStyles);
        tolua_function(tolua_S,"getFactory",lua_cocos2dx_ui_RichTextManager_getFactory);
        tolua_function(tolua_S,"loadStylesByData",lua_cocos2dx_ui_RichTextManager_loadStylesByData);
        tolua_function(tolua_S,"DestroyInstance", lua_cocos2dx_ui_RichTextManager_DestroyInstance);
        tolua_function(tolua_S,"getInstance", lua_cocos2dx_ui_RichTextManager_getInstance);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocos2d::ui::RichTextManager).name();
    g_luaType[typeName] = "ccui.RichTextManager";
    g_typeCast["RichTextManager"] = "ccui.RichTextManager";
    return 1;
}

int lua_cocos2dx_ui_RichTextTyping_getCharCount(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextTyping* cobj = nullptr;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"ccui.RichTextTyping",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (cocos2d::ui::RichTextTyping*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextTyping_getCharCount'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextTyping_getCharCount'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextTyping:getCharCount",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextTyping_getCharCount'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextTyping_destroyTyping(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextTyping* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextTyping_destroyTyping'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextTyping_destroyTyping'", nullptr);
            return 0;
        }
        cobj->destroyTyping();
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextTyping:destroyTyping",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextTyping_destroyTyping'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextTyping_getRemainCharCount(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextTyping* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextTyping_getRemainCharCount'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextTyping_getRemainCharCount'", nullptr);
            return 0;
        }
        int ret = cobj->getRemainCharCount();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextTyping:getRemainCharCount",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextTyping_getRemainCharCount'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextTyping_typeChar(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextTyping* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextTyping_typeChar'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextTyping_typeChar'", nullptr);
            return 0;
        }
        bool ret = cobj->typeChar();
        tolua_pushboolean(tolua_S,(bool)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextTyping:typeChar",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextTyping_typeChar'.",&tolua_err);
#endif

    return 0;
}
static int lua_cocos2dx_ui_RichTextTyping_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (RichTextTyping)");
    return 0;
}

int lua_register_cocos2dx_ui_RichTextTyping(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"ccui.RichTextTyping");
    tolua_cclass(tolua_S,"RichTextTyping","ccui.RichTextTyping","cc.Ref",nullptr);

    tolua_beginmodule(tolua_S,"RichTextTyping");
        tolua_function(tolua_S,"getCharCount",lua_cocos2dx_ui_RichTextTyping_getCharCount);
        tolua_function(tolua_S,"destroyTyping",lua_cocos2dx_ui_RichTextTyping_destroyTyping);
        tolua_function(tolua_S,"getRemainCharCount",lua_cocos2dx_ui_RichTextTyping_getRemainCharCount);
        tolua_function(tolua_S,"typeChar",lua_cocos2dx_ui_RichTextTyping_typeChar);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocos2d::ui::RichTextTyping).name();
    g_luaType[typeName] = "ccui.RichTextTyping";
    g_typeCast["RichTextTyping"] = "ccui.RichTextTyping";
    return 1;
}

int lua_cocos2dx_ui_RichTextUI_insertElement(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextUI* cobj = nullptr;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"ccui.RichTextUI",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (cocos2d::ui::RichTextUI*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextUI_insertElement'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        cocos2d::ui::RichItem* arg0;

        ok &= luaval_to_object<cocos2d::ui::RichItem>(tolua_S, 2, "ccui.RichItem",&arg0);
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_insertElement'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextUI:insertElement",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextUI_insertElement'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextUI_setLineSpace(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextUI* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextUI_setLineSpace'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,&arg0, "ccui.RichTextUI:setLineSpace");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_setLineSpace'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextUI:setLineSpace",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextUI_setLineSpace'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextUI_setAnchorPoint(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextUI* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextUI_setAnchorPoint'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_point(tolua_S, 2, &arg0, "ccui.RichTextUI:setAnchorPoint");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_setAnchorPoint'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextUI:setAnchorPoint",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextUI_setAnchorPoint'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextUI_insertNewLine(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextUI* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextUI_insertNewLine'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_insertNewLine'", nullptr);
            return 0;
        }
        cobj->insertNewLine();
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextUI:insertNewLine",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextUI_insertNewLine'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextUI_getHAlignment(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextUI* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextUI_getHAlignment'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_getHAlignment'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextUI:getHAlignment",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextUI_getHAlignment'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextUI_setTextAlignment(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextUI* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextUI_setTextAlignment'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_setTextAlignment'", nullptr);
            return 0;
        }
        cobj->setTextAlignment();
        lua_settop(tolua_S, 1);
        return 1;
    }
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ccui.RichTextUI:setTextAlignment");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_setTextAlignment'", nullptr);
            return 0;
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 3,(int *)&arg1, "ccui.RichTextUI:setTextAlignment");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_setTextAlignment'", nullptr);
            return 0;
        }
        cobj->setTextAlignment(arg0, arg1);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextUI:setTextAlignment",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextUI_setTextAlignment'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextUI_parseElement(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextUI* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextUI_parseElement'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "ccui.RichTextUI:parseElement"); arg0 = arg0_tmp.c_str();
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_parseElement'", nullptr);
            return 0;
        }
        cobj->parseElement(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 3,&arg1, "ccui.RichTextUI:parseElement");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_parseElement'", nullptr);
            return 0;
        }
        cobj->parseElement(arg0, arg1);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextUI:parseElement",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextUI_parseElement'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextUI_createTyping(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextUI* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextUI_createTyping'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_createTyping'", nullptr);
            return 0;
        }
        cocos2d::ui::RichTextTyping* ret = cobj->createTyping();
        object_to_luaval<cocos2d::ui::RichTextTyping>(tolua_S, "ccui.RichTextTyping",(cocos2d::ui::RichTextTyping*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextUI:createTyping",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextUI_createTyping'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextUI_getVAlignment(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextUI* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextUI_getVAlignment'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_getVAlignment'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextUI:getVAlignment",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextUI_getVAlignment'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextUI_showItemByTag(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextUI* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextUI_showItemByTag'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,&arg0, "ccui.RichTextUI:showItemByTag");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_showItemByTag'", nullptr);
            return 0;
        }
        cobj->showItemByTag(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextUI:showItemByTag",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextUI_showItemByTag'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextUI_getText(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextUI* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextUI_getText'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_getText'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextUI:getText",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextUI_getText'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextUI_setMaxLine(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextUI* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextUI_setMaxLine'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,&arg0, "ccui.RichTextUI:setMaxLine");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_setMaxLine'", nullptr);
            return 0;
        }
        cobj->setMaxLine(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextUI:setMaxLine",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextUI_setMaxLine'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextUI_labelClicked(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextUI* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextUI_labelClicked'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        cocos2d::ui::LinkLable* arg0;

        ok &= luaval_to_object<cocos2d::ui::LinkLable>(tolua_S, 2, "ccui.LinkLable",&arg0);
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_labelClicked'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextUI:labelClicked",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextUI_labelClicked'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextUI_clearAll(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextUI* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichTextUI_clearAll'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_clearAll'", nullptr);
            return 0;
        }
        cobj->clearAll();
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextUI:clearAll",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextUI_clearAll'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_ui_RichTextUI_isEnglishChar(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S,1,"ccui.RichTextUI",0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    {
        int32_t arg0;
        ok &= luaval_to_int32(tolua_S, 2,&arg0, "ccui.RichTextUI:isEnglishChar");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_isEnglishChar'", nullptr);
            return 0;
        }
        bool ret = cocos2d::ui::RichTextUI::isEnglishChar(arg0);
        tolua_pushboolean(tolua_S,(bool)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "ccui.RichTextUI:isEnglishChar",argc, 1);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextUI_isEnglishChar'.",&tolua_err);
#endif
    return 0;
}
int lua_cocos2dx_ui_RichTextUI_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_create'", nullptr);
            return 0;
        }
        cocos2d::ui::RichTextUI* ret = cocos2d::ui::RichTextUI::create();
        object_to_luaval<cocos2d::ui::RichTextUI>(tolua_S, "ccui.RichTextUI",(cocos2d::ui::RichTextUI*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "ccui.RichTextUI:create",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextUI_create'.",&tolua_err);
#endif
    return 0;
}
int lua_cocos2dx_ui_RichTextUI_constructor(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichTextUI* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichTextUI_constructor'", nullptr);
            return 0;
        }
        cobj = new cocos2d::ui::RichTextUI();
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,"ccui.RichTextUI");
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichTextUI:RichTextUI",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichTextUI_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_cocos2dx_ui_RichTextUI_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (RichTextUI)");
    return 0;
}

int lua_register_cocos2dx_ui_RichTextUI(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"ccui.RichTextUI");
    tolua_cclass(tolua_S,"RichTextUI","ccui.RichTextUI","ccui.ScrollView",nullptr);

    tolua_beginmodule(tolua_S,"RichTextUI");
        tolua_function(tolua_S,"new",lua_cocos2dx_ui_RichTextUI_constructor);
        tolua_function(tolua_S,"insertElement",lua_cocos2dx_ui_RichTextUI_insertElement);
        tolua_function(tolua_S,"setLineSpace",lua_cocos2dx_ui_RichTextUI_setLineSpace);
        tolua_function(tolua_S,"setAnchorPoint",lua_cocos2dx_ui_RichTextUI_setAnchorPoint);
        tolua_function(tolua_S,"insertNewLine",lua_cocos2dx_ui_RichTextUI_insertNewLine);
        tolua_function(tolua_S,"getHAlignment",lua_cocos2dx_ui_RichTextUI_getHAlignment);
        tolua_function(tolua_S,"setTextAlignment",lua_cocos2dx_ui_RichTextUI_setTextAlignment);
        tolua_function(tolua_S,"parseElement",lua_cocos2dx_ui_RichTextUI_parseElement);
        tolua_function(tolua_S,"createTyping",lua_cocos2dx_ui_RichTextUI_createTyping);
        tolua_function(tolua_S,"getVAlignment",lua_cocos2dx_ui_RichTextUI_getVAlignment);
        tolua_function(tolua_S,"showItemByTag",lua_cocos2dx_ui_RichTextUI_showItemByTag);
        tolua_function(tolua_S,"getText",lua_cocos2dx_ui_RichTextUI_getText);
        tolua_function(tolua_S,"setMaxLine",lua_cocos2dx_ui_RichTextUI_setMaxLine);
        tolua_function(tolua_S,"labelClicked",lua_cocos2dx_ui_RichTextUI_labelClicked);
        tolua_function(tolua_S,"clearAll",lua_cocos2dx_ui_RichTextUI_clearAll);
        tolua_function(tolua_S,"isEnglishChar", lua_cocos2dx_ui_RichTextUI_isEnglishChar);
        tolua_function(tolua_S,"create", lua_cocos2dx_ui_RichTextUI_create);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocos2d::ui::RichTextUI).name();
    g_luaType[typeName] = "ccui.RichTextUI";
    g_typeCast["RichTextUI"] = "ccui.RichTextUI";
    return 1;
}
TOLUA_API int register_all_cocos2dx_ui(lua_State* tolua_S)
{
	...
	lua_register_cocos2dx_ui_RichItem(tolua_S);
	lua_register_cocos2dx_ui_RichItemText(tolua_S);
	...
	lua_register_cocos2dx_ui_RichTextUI(tolua_S);
	lua_register_cocos2dx_ui_Scale9Sprite(tolua_S);
	lua_register_cocos2dx_ui_VBox(tolua_S);
	lua_register_cocos2dx_ui_LinkLable(tolua_S);
	lua_register_cocos2dx_ui_RichElement(tolua_S);
	lua_register_cocos2dx_ui_RichElementCustomNode(tolua_S);
	lua_register_cocos2dx_ui_RichTextManager(tolua_S);
	lua_register_cocos2dx_ui_RichItemFactory(tolua_S);
	lua_register_cocos2dx_ui_RichItemImageFactory(tolua_S);
	lua_register_cocos2dx_ui_Slider(tolua_S);
	lua_register_cocos2dx_ui_RichItemTextFactory(tolua_S);
	lua_register_cocos2dx_ui_RichItemCustom(tolua_S);
