...
int lua_cocos2dx_spine_SkeletonRenderer_getAttachment(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonRenderer* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonRenderer_getAttachment'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "sp.SkeletonRenderer:getAttachment");

        ok &= luaval_to_std_string(tolua_S, 3,&arg1, "sp.SkeletonRenderer:getAttachment");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_spine_SkeletonRenderer_getAttachment'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "sp.SkeletonRenderer:getAttachment",argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_spine_SkeletonRenderer_getAttachment'.",&tolua_err);
#endif
...
int lua_cocos2dx_spine_SkeletonRenderer_findBone(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonRenderer* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonRenderer_findBone'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "sp.SkeletonRenderer:findBone");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_spine_SkeletonRenderer_findBone'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "sp.SkeletonRenderer:findBone",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_spine_SkeletonRenderer_findBone'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_spine_SkeletonRenderer(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"SkeletonRenderer");
        ...
        tolua_function(tolua_S,"getAttachment",lua_cocos2dx_spine_SkeletonRenderer_getAttachment);
        ...
        tolua_function(tolua_S,"findBone",lua_cocos2dx_spine_SkeletonRenderer_findBone);
...
int lua_cocos2dx_spine_SkeletonAnimation_addNodeToBone(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonAnimation* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonAnimation_addNodeToBone'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "sp.SkeletonAnimation:addNodeToBone");

        ok &= luaval_to_object<cocos2d::Node>(tolua_S, 3, "cc.Node",&arg1);
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_spine_SkeletonAnimation_addNodeToBone'", nullptr);
            return 0;
        }
        cobj->addNodeToBone(arg0, arg1);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "sp.SkeletonAnimation:addNodeToBone",argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_spine_SkeletonAnimation_addNodeToBone'.",&tolua_err);
#endif
...
int lua_cocos2dx_spine_SkeletonAnimation_getBonePos(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonAnimation* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonAnimation_getBonePos'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "sp.SkeletonAnimation:getBonePos");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_spine_SkeletonAnimation_getBonePos'", nullptr);
            return 0;
        }
        cocos2d::Vec2 ret = cobj->getBonePos(arg0);
        vec2_to_luaval(tolua_S, ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "sp.SkeletonAnimation:getBonePos",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_spine_SkeletonAnimation_getBonePos'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_spine_SkeletonAnimation_setOneBoneSkin(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonAnimation* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonAnimation_setOneBoneSkin'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "sp.SkeletonAnimation:setOneBoneSkin");

        ok &= luaval_to_std_string(tolua_S, 3,&arg1, "sp.SkeletonAnimation:setOneBoneSkin");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_spine_SkeletonAnimation_setOneBoneSkin'", nullptr);
            return 0;
        }
        cobj->setOneBoneSkin(arg0, arg1);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "sp.SkeletonAnimation:setOneBoneSkin",argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_spine_SkeletonAnimation_setOneBoneSkin'.",&tolua_err);
#endif
...
int lua_cocos2dx_spine_SkeletonAnimation_setDebugSlot(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonAnimation* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonAnimation_setDebugSlot'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "sp.SkeletonAnimation:setDebugSlot");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_spine_SkeletonAnimation_setDebugSlot'", nullptr);
            return 0;
        }
        cobj->setDebugSlot(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "sp.SkeletonAnimation:setDebugSlot",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_spine_SkeletonAnimation_setDebugSlot'.",&tolua_err);
#endif
...
int lua_cocos2dx_spine_SkeletonAnimation_setSProgram(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonAnimation* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonAnimation_setSProgram'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "sp.SkeletonAnimation:setSProgram");

        ok &= luaval_to_std_string(tolua_S, 3,&arg1, "sp.SkeletonAnimation:setSProgram");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_spine_SkeletonAnimation_setSProgram'", nullptr);
            return 0;
        }
        cobj->setSProgram(arg0, arg1);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "sp.SkeletonAnimation:setSProgram",argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_spine_SkeletonAnimation_setSProgram'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_spine_SkeletonAnimation_setBoneRotation(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonAnimation* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonAnimation_setBoneRotation'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "sp.SkeletonAnimation:setBoneRotation"); arg0 = arg0_tmp.c_str();

        ok &= luaval_to_number(tolua_S, 3,&arg1, "sp.SkeletonAnimation:setBoneRotation");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_spine_SkeletonAnimation_setBoneRotation'", nullptr);
            return 0;
        }
        cobj->setBoneRotation(arg0, arg1);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "sp.SkeletonAnimation:setBoneRotation",argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_spine_SkeletonAnimation_setBoneRotation'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_spine_SkeletonAnimation_getAnimationTime(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonAnimation* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonAnimation_getAnimationTime'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "sp.SkeletonAnimation:getAnimationTime");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_spine_SkeletonAnimation_getAnimationTime'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "sp.SkeletonAnimation:getAnimationTime",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_spine_SkeletonAnimation_getAnimationTime'.",&tolua_err);
#endif
...
int lua_cocos2dx_spine_SkeletonAnimation_setDebugBone(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonAnimation* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonAnimation_setDebugBone'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "sp.SkeletonAnimation:setDebugBone");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_spine_SkeletonAnimation_setDebugBone'", nullptr);
            return 0;
        }
        cobj->setDebugBone(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "sp.SkeletonAnimation:setDebugBone",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_spine_SkeletonAnimation_setDebugBone'.",&tolua_err);
#endif
...
int lua_cocos2dx_spine_SkeletonAnimation_getBoneAngle(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonAnimation* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonAnimation_getBoneAngle'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "sp.SkeletonAnimation:getBoneAngle");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_spine_SkeletonAnimation_getBoneAngle'", nullptr);
            return 0;
        }
        double ret = cobj->getBoneAngle(arg0);
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "sp.SkeletonAnimation:getBoneAngle",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_spine_SkeletonAnimation_getBoneAngle'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_spine_SkeletonAnimation(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"SkeletonAnimation");
        ...
        tolua_function(tolua_S,"addNodeToBone",lua_cocos2dx_spine_SkeletonAnimation_addNodeToBone);
        ...
        tolua_function(tolua_S,"getBonePos",lua_cocos2dx_spine_SkeletonAnimation_getBonePos);
        tolua_function(tolua_S,"setOneBoneSkin",lua_cocos2dx_spine_SkeletonAnimation_setOneBoneSkin);
        tolua_function(tolua_S,"setEventListener",lua_cocos2dx_spine_SkeletonAnimation_setEventListener);
        tolua_function(tolua_S,"setDebugSlot",lua_cocos2dx_spine_SkeletonAnimation_setDebugSlot);
        tolua_function(tolua_S,"clearTrack",lua_cocos2dx_spine_SkeletonAnimation_clearTrack);
        tolua_function(tolua_S,"setSProgram",lua_cocos2dx_spine_SkeletonAnimation_setSProgram);
        tolua_function(tolua_S,"setBoneRotation",lua_cocos2dx_spine_SkeletonAnimation_setBoneRotation);
        tolua_function(tolua_S,"getAnimationTime",lua_cocos2dx_spine_SkeletonAnimation_getAnimationTime);
        ...
        tolua_function(tolua_S,"setDebugBone",lua_cocos2dx_spine_SkeletonAnimation_setDebugBone);
        tolua_function(tolua_S,"setStartListener",lua_cocos2dx_spine_SkeletonAnimation_setStartListener);
        tolua_function(tolua_S,"getBoneAngle",lua_cocos2dx_spine_SkeletonAnimation_getBoneAngle);
