...
int lua_cocos2dx_studio_ActionManagerEx_getActionByNameEx(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::ActionManagerEx* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_ActionManagerEx_getActionByNameEx'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 3) 
    {
        const char* arg0;
        const char* arg1;
        cocos2d::Vector<cocos2d::Node *> arg2;

        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "ccs.ActionManagerEx:getActionByNameEx"); arg0 = arg0_tmp.c_str();

        std::string arg1_tmp; ok &= luaval_to_std_string(tolua_S, 3, &arg1_tmp, "ccs.ActionManagerEx:getActionByNameEx"); arg1 = arg1_tmp.c_str();

        ok &= luaval_to_ccvector(tolua_S, 4, &arg2, "ccs.ActionManagerEx:getActionByNameEx");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_studio_ActionManagerEx_getActionByNameEx'", nullptr);
            return 0;
        }
        cocostudio::ActionObject* ret = cobj->getActionByNameEx(arg0, arg1, arg2);
        object_to_luaval<cocostudio::ActionObject>(tolua_S, "ccs.ActionObject",(cocostudio::ActionObject*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccs.ActionManagerEx:getActionByNameEx",argc, 3);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ActionManagerEx_getActionByNameEx'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_studio_ActionManagerEx(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"ActionManagerEx");
        ...
        tolua_function(tolua_S,"getActionByNameEx",lua_cocos2dx_studio_ActionManagerEx_getActionByNameEx);
...
int lua_cocos2dx_studio_GUIReader_getFileDesignSize(lua_State* tolua_S)
{
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_GUIReader_getFileDesignSize'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "ccs.GUIReader:getFileDesignSize"); arg0 = arg0_tmp.c_str();
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_studio_GUIReader_getFileDesignSize'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccs.GUIReader:getFileDesignSize",argc, 1);
    return 0;
...
int lua_cocos2dx_studio_GUIReader_storeFileDesignSize(lua_State* tolua_S)
{
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_GUIReader_storeFileDesignSize'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, "ccs.GUIReader:storeFileDesignSize"); arg0 = arg0_tmp.c_str();

        ok &= luaval_to_size(tolua_S, 3, &arg1, "ccs.GUIReader:storeFileDesignSize");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_studio_GUIReader_storeFileDesignSize'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccs.GUIReader:storeFileDesignSize",argc, 2);
    return 0;
...
int lua_cocos2dx_studio_GUIReader_getJsonCacheDocument(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::GUIReader* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_GUIReader_getJsonCacheDocument'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "ccs.GUIReader:getJsonCacheDocument");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_studio_GUIReader_getJsonCacheDocument'", nullptr);
            return 0;
        }
        rapidjson::GenericDocument<rapidjson::UTF8<char>, rapidjson::MemoryPoolAllocator<rapidjson::CrtAllocator> >* ret = cobj->getJsonCacheDocument(arg0);
        object_to_luaval<rapidjson::GenericDocument<rapidjson::UTF8<char>, rapidjson::MemoryPoolAllocator<rapidjson::CrtAllocator> >>(tolua_S, "rj.GenericDocument<rj.UTF8<char>, rj.MemoryPoolAllocator<rj.CrtAllocator> >",(rapidjson::GenericDocument<rapidjson::UTF8<char>, rapidjson::MemoryPoolAllocator<rapidjson::CrtAllocator> >*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccs.GUIReader:getJsonCacheDocument",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_GUIReader_getJsonCacheDocument'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_studio_GUIReader(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GUIReader");
        ...
        tolua_function(tolua_S,"getJsonCacheDocument",lua_cocos2dx_studio_GUIReader_getJsonCacheDocument);
