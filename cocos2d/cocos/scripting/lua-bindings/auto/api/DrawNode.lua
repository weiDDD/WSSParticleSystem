...
--------------------------------
-- @overload self, vec2_table, vec2_table, vec2_table, color4f_table, color4f_table, color4f_table         
-- @overload self, vec2_table, vec2_table, vec2_table, color4f_table         
-- @function [parent=#DrawNode] drawTriangle
-- @param self
-- @param #vec2_table p1
-- @param #vec2_table p2
-- @param #vec2_table p3
-- @param #color4f_table color1
-- @param #color4f_table color2
-- @param #color4f_table color3
-- @return DrawNode#DrawNode self (return value: cc.DrawNode)
